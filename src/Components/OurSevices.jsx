            ...
            >
              <div className="p-8 h-full flex flex-col bg-[#cdab56] justify-between">
                <div>
                  ...
                  <p className="text-sm text-black mb-6 group-hover:text-gray transition-colors duration-300">
                    {service.description}
                  </p>
                </div>
                <div className="flex items-center text-black group cursor-pointer">
                  <span className="text-sm font-semibold group-hover:text-white transition-colors duration-300">
                    Learn More
                  </span>
                  <ArrowRight className="ml-2 h-4 w-4 transition-all duration-300 group-hover:translate-x-2 group-hover:text-white " />
                </div>
              </div>
            </motion.div>
          ))}
